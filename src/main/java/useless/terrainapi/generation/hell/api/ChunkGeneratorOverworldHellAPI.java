...
public class ChunkGeneratorOverworldHellAPI extends ChunkGeneratorPerlin {
	public ChunkGeneratorOverworldHellAPI(World world) {
		super(world, new ChunkDecoratorOverworldHellAPI(world), new TerrainGeneratorOverworld(world), new SurfaceGeneratorOverworld(world), new CavesLargeFeature[]{new CavesLargeFeature()});
	}
}
