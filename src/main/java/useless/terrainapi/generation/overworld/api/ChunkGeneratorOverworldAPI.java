...
public class ChunkGeneratorOverworldAPI extends ChunkGeneratorPerlin {
	public ChunkGeneratorOverworldAPI(World world) {
		super(world, new ChunkDecoratorOverworldAPI(world), new TerrainGeneratorOverworld(world), new SurfaceGeneratorOverworld(world), new CavesLargeFeature[]{new CavesLargeFeature()});
	}
}
