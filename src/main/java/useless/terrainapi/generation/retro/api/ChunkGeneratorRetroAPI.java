...
public class ChunkGeneratorRetroAPI extends ChunkGeneratorPerlin {
	public ChunkGeneratorRetroAPI(World world) {
		super(world, new ChunkDecoratorRetroAPI(world), new TerrainGeneratorOverworldRetro(world), new SurfaceGeneratorOverworldRetro(world), new CavesLargeFeature[]{new CavesLargeFeature()});
	}
}
